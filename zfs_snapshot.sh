...
# ARG_HELP([Create a ZFS snapshot of a dataset, optionally mount it, and execute a command])
# ARGBASH_GO()
...
{
	local first_option all_short_options='meh'
	first_option="${1:0:1}"
...
print_help()
{
	printf '%s\n' "Create a ZFS snapshot of a dataset, optionally mount it, and execute a command"
	printf 'Usage: %s [-m|--mountpoint <arg>] [-e|--exec <arg>] [-h|--help] <dataset> <snapshot_name>\n' "$0"
